...
switch($_GET[act]){
  ...
  default:
    echo "<h2>Sub Kategori</h2>
          <input type=button value='Tambah Sub Kategori' onclick=\"window.location.href='?module=submenu&act=tambahsubmenu';\">
          <table class='list'><thead>
          <tr><td class='center'>no</td>
          <td class='center'>sub Kategori</td>
          <td class='center'>kategori utama</td>
          <td class='left'>link subkategori</td>
          <td class='center'>aktif</td>
          <td class='center'>admin sub kategori</td>
  ...
  case "tambahsubmenu":
    echo "<h2>Tambah Sub Kategori</h2>
          ...
          <tr><td class='left' width='100'>Sub Kategori</td>     <td class='left'> : <input type=text name='nama_sub' size='40'></td></tr>
          <tr><td class='left'>Kategori Utama</td>  <td class='left'> : 
    ...
    echo "</select></td></tr>
          <tr><td class='left'>Pilih Sub Kategori</td>  <td> : 
    ...
    echo "</select></td></tr>
          <tr><td class='left'>Link Sub Kategori</td><td class='left'> : <input type=text name='link_sub' size='60'></td></tr>
          
          <tr><td class='left'>Aktif</td><td class='left'> : <input type=radio name='aktif' value='Y' checked>Y 
                                                             <input type=radio name='aktif' value='N'>N</td></tr>
          <tr><td class='left'>Admin Sub Kategori</td><td class='left'> : <input type=radio name='adminsubmenu' value='Y'>Y 
