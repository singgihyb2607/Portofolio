...
switch($_GET[act]){
  // Tampil Menu Utama
  default:
    echo "<h2>Kategori Utama</h2>
          <input type=button value='Tambah Kategori Utama' 
  ...
  case "tambahmenuutama":
    echo "<h2>Tambah Kategori Utama</h2>
          <form method=POST action='$aksi?module=menuutama&act=input'>
          <table class='list'><tbody>
          <tr><td class='left' width='70'>Nama Kategori</td><td class='left'> : <input type=text name='nama_menu'></td></tr>
  ...
  case "editmenuutama":
    ...
    echo "<h2>Edit Kategori Utama</h2>
          <form method=POST action=$aksi?module=menuutama&act=update>
          <input type=hidden name=id value='$r[id_main]'>
          <table class='list'><tbody>
          <tr><td class='left' width='70'>Nama Kategori</td><td class='left'> : <input type=text name='nama_menu' value='$r[nama_menu]'></td></tr>
