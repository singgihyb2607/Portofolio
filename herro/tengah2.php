...
echo"<div id='discount'>
					...
					<div id='photo'>
						...
						<div class='text'>
							<p><span>SELAMAT DATANG...</span> di toko online kami, solusi berbelanja mudah dan murah </p>
							<p>Pilihlah produk unggulan kami<br />bermacam kategori barang kami suguhkan <br /> silahkan pilih sesuai kebutuhan anda<br /><span> SELAMAT berbelanja</span> </p>
						</div>
					</div>";
  ...
  <div id='items'>
						<div class='item'>
							...
							<h5 class='news2'>$r[nama_produk]</a></h5>
							<div class='itemimage'>
								<a href='foto_produk/$r[gambar]' title='$r[nama_produk]' class='lightbox'>
               <img src='foto_produk/small_$r[gambar]' border='0' height='150' width='150' title='klik untuk memperbesar gambar' /></a<br />
								<p class='more'><a href='produk-$r[id_produk]-$r[produk_seo].html' class='prod_details''>DETAIL</a></p>
							</div>
							<div class='price'>
								$divharga<br />
...
echo"<img src='images/tpart.png' alt='' width='49' height='23' class='transparent' />";
											
  // Tampilkan detail produk berdasarkan produk yang dipilih
	$detail=mysql_query("SELECT * FROM produk,subkategori    
                      WHERE subkategori.id_subkategori=produk.id_subkategori 
  ...
  echo "
  <div id='items'>
  <h5 class='detiltitle'>$r[nama_produk]</h5>
  
    	  <div class='prod_box_big'>
        	
                   
                 <div class='product_img_big'>
                 <a href='#'><img src='foto_produk/$r[gambar]' border='0' height='300' width='250'/></a>
				 
				 <div class='textwhite'>$r[deskripsi]</div>
			<div class='price'>	 
            $divharga
            <div class='textgreen'>(stok: $r[stok])</div><br/>
            $tombol
            </div>
              </div><br/>
		   ...
		   $sql=mysql_query("SELECT * FROM produk ORDER BY rand() LIMIT 10");
      
 
     echo "<div class='lain'>Produk Lainnya</div></br>";   
  while ($r=mysql_fetch_array($sql)){
...
echo"<img src='images/tpart.png' alt='' width='49' height='23' class='transparent' />";
  ...
  echo "<div class='center_title_bar'>Profil Kami</div>
    	  <div class='prod_box_big'>
...
echo"<img src='images/tpart.png' alt='' width='49' height='23' class='transparent' />";
  echo "<div class='center_title_bar'>Hubungi Kami</div>
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Hubungi Kami Secara Online:</div>
              <div>
        <table width=95% style='border: 1pt dashed #0000CC;padding: 10px;'>
        ...
        <tr><td>&nbsp;</td><td>(masukkan 6 kode di atas)<br /><input type=text name=kode size=6 maxlength=6><br /></td></tr>
		  ...
		  <div class='center_title_bar'>For Fast respon :</div>";
	  ...
	  while($k=mysql_fetch_array($kontak)){
			...
			<strong>No Tlp: $k[nomor_hp]</strong></br>
			<strong>Email: $k[email_pengelola]</strong></br> 
	        <strong>Pin BB: $k[pin_bb]</strong></br> 
	         </div></br></br>";
     ...
     echo "<div class='center_title_bar'>Lokasi kami</div></br><div class='details_big_box'><iframe width='555' height='340' frameborder='0' scrolling='no' marginheight='0'  marginwidth='0' src='$t[iframe]'> </iframe><br /><div align='center'><a href='$t[detail]' title='Lokasi toko kami'><strong>View Larger Map</strong></a></div>
...
echo"<img src='images/tpart.png' alt='' width='49' height='23' class='transparent' />";
  ...
  $sq = mysql_query("SELECT nama_subkategori from subkategori where id_subkategori='$_GET[id]'");
  $n = mysql_fetch_array($sq);

  echo "<h51 class='detiltitle'>Kategori: $n[nama_subkategori]</h51>";
  ...
  // Tampilkan daftar produk yang sesuai dengan kategori yang dipilih
 	$sql = mysql_query("SELECT * FROM produk WHERE id_subkategori='$_GET[id]' 
  ...
  $jmldata     = mysql_num_rows(mysql_query("SELECT * FROM produk WHERE id_subkategori='$_GET[id]'"));
...
echo"<img src='images/tpart.png' alt='' width='49' height='23' class='transparent' />";
  echo "<h51 class='detiltitle'>Semua Produk</h51>";
  // Tentukan berapa data yang akan ditampilkan per halaman (paging)
  $p      = new Paging2;
  $batas  = 6;
  $posisi = $p->cariPosisi($batas);
  ...
  echo "<div class='textwhite'>Halaman : $linkHalaman </div>";
}
        ...
        <div class='center_prod_box_big'>            
          <div class='details_big_cari'>
            <div class='product_title_big'><a href=produk-$t[id_produk]-$t[produk_seo].html>$t[nama_produk]</a></div>
              <div>
              $isi ... <a href=produk-$t[id_produk]-$t[produk_seo].html>selengkapnya</a>
              </div>
          </div>    
          </div>
...
echo"<img src='images/tpart.png' alt='' width='49' height='23' class='transparent' />";
  ...
  if($ketemu < 1){
    ...
    echo "<h51 class='detiltitle'>Keranjang Belanja</h51>
        ...
        <div class='center_prod_box_big'>            
          ...
          <tbody>
          <tr bgcolor=#E2EDF3><th>No</th><th>Produk</th><th>Nama Produk</th><th>Berat(Kg)</th><th>Qty</th>
  ...
  while($r=mysql_fetch_array($sql)){
    ...
    echo "<tr bgcolor=#C6E6F8><td>$no</td><input type=hidden name=id[$no] value=$r[id_orders_temp]>
              <td align=center><br><img src=foto_produk/small_$r[gambar] height='100' width='90'></td>
              <td>$r[nama_produk]</td>
  ...
  echo "<tr><td colspan=6 align=right><br><div class='textwhite'><b>Total:</b></div></td><td colspan=2><br><div class='textwhite'>Rp. <b>$total_rp</b></div></td></tr>
        <tr><td colspan=3><br /><a href='index.php' class='button'>Lanjutkan Belanja</a><br /></td>
        <td colspan=5 align=right><br /><a href='selesai-belanja.html' class='button'>Selesai Belanja</a></a><br /></td></tr>
        </tbody></table></form><br />
        <div class='textwhite'>*) Total harga diatas belum termasuk ongkos kirim yang akan dihitung saat <b>Selesai Belanja</b>.</div>
...
echo"<img src='images/tpart.png' alt='' width='49' height='23' class='transparent' />";
  ...
  echo "<div class='center_title_bar'>Kustomer Baru</div>";
      ...
      <tr><td>Alamat Pengiriman</td><td> : <input type=text name=alamat size=50>
     </td></tr>
...
if ($cek_email > 0){
  echo "<center>Email <b>$_POST[email]</b> sudah ada yang pakai.<br />
...
elseif (empty($_POST[nama]) || empty($_POST[password]) || empty($_POST[alamat]) || empty($_POST[telpon]) || empty($_POST[email]) || empty($_POST[kota]) || empty($_POST[kode])){
  echo "<center>Data yang Anda isikan belum lengkap<br />
  	    <a href='selesai-belanja.html'><b>Ulangi Lagi</b></center>";
}
elseif (!ereg("[a-z|A-Z]","$_POST[nama]")){
  echo "<center>Nama tidak boleh diisi dengan angka atau simbol.<br />
 	      <a href=javascript:history.go(-1)><b>Ulangi Lagi</b></a></center>";
}
elseif (strlen($kar1)==0 OR strlen($kar2)==0){
  echo "<center>Alamat email Anda tidak valid, mungkin kurang tanda titik (.) atau tanda @.<br />
 	      <a href=javascript:history.go(-1)><b>Ulangi Lagi</b></a></center>";
}
else{
...
echo "<table border=0 cellpadding=3 align=center width=95%>
      <tr bgcolor=#C6E6F8><th>No</th><th>Nama Produk</th><th>Berat(Kg)</th><th>Qty</th><th>Harga Satuan</th><th>Sub Total</th></tr>";
...
if ($cek_email == 0){
  echo "<center>Email <b>$_POST[email]</b> tidak terdaftar di database kami.<br />
        <a href=javascript:history.go(-1)><b>Ulangi Lagi</b></a></center>";
}
else{
